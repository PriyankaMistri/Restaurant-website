...
echo "<tr><td>". $row["id"] ."<td>  ".$row["name"]."   <td>".$row["lastname"]." <td> ". $row["date"]." <td>  ".$row["time"]." <td>  ".$row["guest"]." <td>  ".$row["reservationtype"]."<td><a href=ApproveBooking.php?id=".$row["id"].">Approve</a><td><a href=RejectBooking.php?id=".$row["id"].">Reject</a>";
